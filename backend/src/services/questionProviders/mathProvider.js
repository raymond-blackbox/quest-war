/**
 * Math Question Provider
 * Generates random math questions with 4 multiple choice options.
 * This is a refactored version of the original questions.js module.
 */
...
/**
 * Generate a single question with the specified difficulty
 * @param {string} difficulty - One of DIFFICULTY.EASY, MEDIUM, HARD
 * @returns {Object} Question object with question, options, and correctIndex
 */
